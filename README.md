...
Parts of this extension were written using the Codex LLM. Care was taken that all tooltips and logic do match the documentation as precisely as possible. Yet there may be dragons.
